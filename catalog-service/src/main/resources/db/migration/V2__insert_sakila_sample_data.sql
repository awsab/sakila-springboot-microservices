-- Full Sakila-derived reference and catalog data for Flyway.
-- Extracted from the public Sakila sample dataset and adapted to the
-- catalog-service schema defined in V1__create_tables.sql.
...
-- film_text is derived from the imported film rows because this schema
-- does not use the original Sakila triggers that maintain the mirror table.
